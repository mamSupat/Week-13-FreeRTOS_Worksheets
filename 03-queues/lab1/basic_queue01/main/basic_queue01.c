...
static const char *TAG = "QUEUE_LAB_FULL_TEST";
...
// Sender task (ส่งเร็วขึ้นทุก 0.5 วินาที)
void sender_task(void *pvParameters) {
    ...
    while (1) {
        ...
        vTaskDelay(pdMS_TO_TICKS(500)); // ส่งทุก 0.5 วินาที (ทดสอบ Queue เต็ม)
    }
}
...
void app_main(void) {
    ESP_LOGI(TAG, "🧪 Queue Full Test Starting...");
